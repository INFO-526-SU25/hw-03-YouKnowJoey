...
response_labels <- c( 
  "resp_safety" = "Based on my understanding, I believe the vaccine is safe", # 1
  "resp_feel_safe_at_work" = "Getting the vaccine will make me feel safer at work", # 2
  "resp_concern_safety" = "I am concerned about the safety and side effects of the vaccine", # 3
  "resp_confidence_science" = "I am confident in the scientific vetting process for the new COVID vaccines", # 4
  "resp_trust_info" = "I trust the information that I have received about the vaccines", # 5
  "resp_will_recommend" = "I will recommend the vaccine to family, friends, and community members" # 6
)
...
covid_survey_summary_stats |>
  ...
  ggplot(aes(y = fct_rev(explanatory_value), x = low, xend = high)) +
  geom_dumbbell(color = "gray", size = 2) +
  ...
  theme_minimal() +
  theme(
    strip.text.y = element_text(angle = 0, hjust = 1, size = 12), # Rotate "explanatory" labels
